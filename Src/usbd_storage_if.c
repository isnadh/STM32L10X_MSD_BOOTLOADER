...
//#define STORAGE_BLK_NBR                  0x3C000
...
{
  /* USER CODE BEGIN 6 */
	_STORAGE_ReadBlocks((uint32_t *)buf, (uint64_t)(blk_addr * STORAGE_BLK_SIZ), STORAGE_BLK_SIZ, blk_len);			//lingex
  return (USBD_OK);
  /* USER CODE END 6 */
}
...
{
  /* USER CODE BEGIN 7 */
	_STORAGE_WriteBlocks((uint32_t *)buf, (uint64_t)(blk_addr * STORAGE_BLK_SIZ), STORAGE_BLK_SIZ, blk_len);		//lingex
  return (USBD_OK);
  /* USER CODE END 7 */
}
